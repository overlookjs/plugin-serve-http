...
const serveHttpPlugin = new Plugin(
	...
	(Route, {
		...
		SOCKETS, IS_IDLE, IS_STOPPING,
		START_CHILDREN, STOP_CHILDREN
	}) => class HttpServerRoute extends Route {
		[INIT_PROPS](props) {
...
// Re-export REQ_TYPE + PATH symbols from @overlook/plugin-request
serveHttpPlugin.REQ_TYPE = REQ_TYPE;
serveHttpPlugin.PATH = PATH;
